/**
 * @file   SSSMeshRenderer.cpp
 * @author Sebastian Maisch <sebastian.maisch@uni-ulm.de>
 * @date   2018.08.29
 *
 * @brief  Definition of the mesh renderer for subsurface scattering.
 */

#include "SSSMeshRenderer.h"
...
namespace pcViewer {
    ...
    SSSMeshRenderer::SSSMeshRenderer(ApplicationNodeImplementation* appNode) :
        MeshRenderer{ PCType::SUBSURFACE, appNode }
    {
    }

    void SSSMeshRenderer::RenderGUIByType()
    {
    ...
    void SSSMeshRenderer::ExportScreenPointCloudScreen(const FrameBuffer& fbo, std::ostream& screenPoints) const
    {
