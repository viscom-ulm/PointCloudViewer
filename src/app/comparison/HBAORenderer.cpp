...
namespace pcViewer {
        ...
        BaseRenderer{ PCType::AO, RenderType::PC_ON_MESH, "HBAO", appNode }
    {
        ...
        hbaoUniformLocations_ = hbaoQuad_->GetGPUProgram()->GetUniformLocations({ "positionTexture", "normalTexture", "materialColorTexture", "directIlluminationTexture", "noiseTexture", "camPos" });
