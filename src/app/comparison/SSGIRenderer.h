...
namespace pcViewer {
    ...
    class SSGIRenderer : public BaseRenderer
    {
    public:
        SSGIRenderer(ApplicationNodeImplementation* appNode);
    ...
    private:
        ...
        std::unique_ptr<FullscreenQuad> ssgiQuad_;
        /** Holds the uniform bindings for final rendering. */
        std::vector<gl::GLint> ssgiUniformLocations_;
